...
- **Related:** [ADR-011](./ADR-011-grid-interaction-architecture.md) (deferred this as "Step 0"), [ADR-012](./ADR-012-column-width.md) (the first instance of ADR-011's model), [ADR-052](./ADR-052-keyset-pagination-for-infinite-scroll.md) (where a page of rows comes from)

## Context

[ADR-011](./ADR-011-grid-interaction-architecture.md)
...
- [ADR-011](./ADR-011-grid-interaction-architecture.md) — deferred this as "Step 0", and assigned ARIA role/focus mechanics to the surface layer
