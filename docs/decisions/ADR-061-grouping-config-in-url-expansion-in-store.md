...
- [ADR-010](./ADR-010-cookie-persistence-server-action.md) — the persist-cookie flow this rides
...
- [ADR-009](./ADR-009-serializable-filter-options-descriptors.md) — why loader-crossing data is plain and serializable
