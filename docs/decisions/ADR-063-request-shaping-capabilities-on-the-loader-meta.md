...
- **Related:** [ADR-009](./ADR-009-serializable-filter-options-descriptors.md) (serializable loader data), ADR-043 (Changesets), ADR-046 (public API-surface snapshot), ADR-052 (keyset cursor), ADR-058 and ADR-059 (grouping)
