...
- Baselines + reports live in [reports/fallow/](../../reports/fallow/).
- Deep-scan workflow: the `fallow-code-checker` skill / `fallow-scan` agent produce prioritized reports under `.tmp/fallow-code-checker/`.
