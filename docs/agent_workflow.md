...
| Merge                  | [`merge_checklist.md`](merge_checklist.md)                                                 |
...
Work through [`merge_checklist.md`](merge_checklist.md). Abort if any item fails.
...
`merge_checklist.md` only when the merge bar changes. Neither is a general
changelog.
...
## Relationship to `AGENT_WORKFLOW_TEMPLATES.md`

[`AGENT_WORKFLOW_TEMPLATES.md`](../AGENT_WORKFLOW_TEMPLATES.md) at the repo root
