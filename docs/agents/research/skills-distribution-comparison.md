...
1. **No documented reasoning for rejecting the editor-native plugin route.**
   ...
   "a later reader must be able to tell 'considered and kept' from 'not looked
   at'" (quoted from `CLASSIFICATION.md`, which ADR-081 governs). Right now a
