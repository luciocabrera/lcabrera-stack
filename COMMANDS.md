...
`scripts:verify`, `docs:verify`, `renames:verify`, `research:verify`,
`route-names:verify`,
...
| `vp run research:verify`     | check every count in `docs/agents/research/` names the command that produces it, or lists what it counts                                                                                                                                                                             |
