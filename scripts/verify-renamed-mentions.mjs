 ...
 *
 * Usage:
 *   node scripts/verify-renamed-mentions.mjs              vs origin/main
 *   node scripts/verify-renamed-mentions.mjs --base <ref> vs an explicit ref
 *
 * Env:
