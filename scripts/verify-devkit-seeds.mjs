 ...
 * lives in `apps/react-router`, so a seed naming the directory matched no
 * package name and passed — which is how a shipped rule kept a blueprint path
 * pointing into an app no consumer has (#860).
 */
