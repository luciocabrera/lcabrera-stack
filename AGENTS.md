...
| `.claude/rules/scripts.md`           | `**/*.mjs`, `**/*.cjs`, anything under `**/scripts/**`          | Build/tooling script standards — JSDoc "why" header, small pure functions, effects at edges, `node:` builtins, 350-line size ceiling (`scripts:verify`)                                    |
