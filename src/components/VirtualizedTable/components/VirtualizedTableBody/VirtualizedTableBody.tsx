...
import type { VirtualizedTableBodyProps } from './VirtualizedTableBody.types';

import { TableCell, TableRow } from '../../../Table';
import { styles } from './VirtualizedTableBody.stylex';

export function VirtualizedTableBody<T extends Record<string, unknown>>({
  columns,
  data,
  overscan,
  rowHeight,
  ...
  return (
    <tbody {...stylex.props(styles.body(totalHeight))}>
      {/* Top spacer row */}
      {offsetY > 0 && (
