...
| `affected-tests.mjs`, `changed-runner.mjs`, `coverage-workspaces.mjs`                                                               | The change-scoped runners: which workspaces a diff touched plus their dependents, and the never-baseline package roster.                                                                                                                                          |
...
`coverage-workspaces`, `jsonc` and the `conformance-*` readers are exported and
