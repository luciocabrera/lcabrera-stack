...
export const renderIndex = (home) =>
  [
    ...
    '',
    '<!-- Generated by `repo-verify-adrs --write`. Do not edit by hand. -->',
    '',
    home.blurb,
    '',
    ...
    'or run `repo-adr`, which takes the next free number for you.',
    '',
    ...
    'sequenced. Run `repo-verify-adrs --list` for every ADR with its title.',
    '',
  ].join('\n');
