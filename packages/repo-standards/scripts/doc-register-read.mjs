...
export const readRegisters = (
  root,
  { planningDir = PLANNING_DIR, requirementsDir = REQUIREMENTS_DIR } = {},
) => {
  ...
  return {
    ...
    planning: readEntries(root, planningDir, 'planning'),
    planningDir,
    requirements: readEntries(root, requirementsDir, 'requirement'),
    requirementsDir,
