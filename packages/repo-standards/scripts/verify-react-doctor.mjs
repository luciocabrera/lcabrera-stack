 ...
 *
 * Usage:
 *   repo-verify-react-doctor            # gate: fails on any error
 *   repo-verify-react-doctor --report   # report only, never fails
 *
...
const REPORT = readGates(REPO_ROOT).reactDoctor.reportFile;
