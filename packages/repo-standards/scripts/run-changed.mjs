 ...
 *   git diff --name-only "$(git merge-base origin/main HEAD)" | repo-run-changed typecheck
 *   … | repo-run-changed typecheck --markdown   # selection summary as markdown
 *   … | repo-run-changed typecheck --dry-run    # print the vp command, run nothing
 *
