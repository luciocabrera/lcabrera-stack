...
/**
 * Whether a share of the grand total is defined for this aggregate.
 *
 * Only an **additive** measure has one, because the denominator is derived from
 * the rows the read returned rather than asked of the server (ADR-086): under
