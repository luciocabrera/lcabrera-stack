...
/**
 * It may not when focus has moved somewhere else on the page: a focused row that scrolled
 * out of the window is unmounted and re-mounts with the request still standing, so without
 * this check, scrolling back to a row the user had left behind would yank focus out of
