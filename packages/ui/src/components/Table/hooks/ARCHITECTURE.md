...
├── useTableColumnLayoutLock.hook.ts     → Whether a grouped column refuses pinning, and hiding with it — asked once by `PinAndHideActions`, drilled to its four delegates
├── utils/
