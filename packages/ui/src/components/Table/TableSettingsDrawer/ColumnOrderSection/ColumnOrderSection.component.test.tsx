...
vi.mock('@repo/ui/components/DraggableList', () => ({
  DraggableList: ({
    items,
    onOrderChange,
  }: {
...
vi.mock(
  '@repo/ui/components/Table/TableSettingsDrawer/TableDrawerContext/selectors',
  () => ({
...
vi.mock('@repo/ui/components/ToggleSwitch', () => ({
  ToggleSwitch: ({
    isChecked,
    isDisabled,
    label,
