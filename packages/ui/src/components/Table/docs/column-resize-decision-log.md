...
| --- | ----------------------------------------- | --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Prefer top-level await over promise chain | `scripts/merge-coverage.mjs`            | **Fixed.** Both branches re-verified: success merges 1,396 files; forced failure prints and exits 1.                                                                                                                                                        |
