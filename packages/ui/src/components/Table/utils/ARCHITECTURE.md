...
├── getNextStatePatch.util.ts                     → Build the next table-meta patch after column-settings accept
...
| getNextStatePatch            | metaState                                     | Partial<TableMetaState>                                                    | Compute the persisted meta patch after accepting column settings                                                                                                                                              |
