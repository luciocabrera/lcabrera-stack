...
| File                                      | Description                                                                                                                                                                                                                                                                                                                         |
| ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `createTableRouteLoader.util.ts`          | Factory: builds a table route's `loader` from config + a `fetchPage` callback — reads state, sanitizes sorting, appends the primary-key tiebreaker, optionally bakes distinct descriptors, and assembles the serializable `columnsState` / `metaState` / remount `key`. Returns the fetch promise unawaited for Suspense streaming. |
