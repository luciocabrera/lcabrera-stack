...
import type { NumberFilterInputProps, UpdateFilterArgs } from "./NumberFilterInput.types.ts";
...
export const NumberFilterInput = <TData,>({
  ...
  const handleMaxValueChange = (e: React.ChangeEvent<HTMLInputElement, HTMLInputElement>) => {
