...
import type { TableBodyProps } from "./TableBody.types.ts";

import { styles } from "./TableBody.stylex.ts";
...
export const TableBody = ({ tableContainerRef }: TableBodyProps) => {
  ...
  return (
    <tbody data-testid="table-body" {...stylex.props(styles.body(totalHeight))}>
      ...
      <TableBodyRows endIndex={endIndex} isLoadingState={isLoadingState} startIndex={startIndex} />
