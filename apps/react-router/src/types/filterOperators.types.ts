 ...
 */
export type ColumnFilter = BooleanFilter | DateFilter | NumberFilter | SelectFilter | TextFilter;
...
export type OperatorType = DateOperatorType | NumberOperatorType | TextOperatorType;
/**
