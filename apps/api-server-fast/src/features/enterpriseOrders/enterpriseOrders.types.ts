import type { DbRow, DistinctValuesResponse, PaginatedResponse } from "../../types/api.types";
...
export type EnterpriseOrdersFilters = Readonly<Record<string, EnterpriseOrdersFilter>>;
