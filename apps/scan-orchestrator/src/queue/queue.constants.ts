...
/**
 * Where a runner lives. `installed` is a subpath of `@repo/scan-report`,
...
export const DETERMINISTIC_SCANNER_CONFIGS = {
  ...
  eslint: {
    ...
    runner: {
      kind: 'installed',
      specifier: '@repo/scan-report/generate-eslint-report',
    },
  },
  fallow: {
    ...
    runner: {
      kind: 'installed',
      specifier: '@repo/scan-report/generate-fallow-report',
    },
  },
  oxlint: {
    ...
    runner: {
      kind: 'installed',
      specifier: '@repo/scan-report/generate-oxlint-report',
    },
  },
