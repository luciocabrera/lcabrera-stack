...
| `ProjectSyncPanel`             | `routes/cqms/project-detail/ProjectSyncPanel/`        | Snapshot sync panel (ADR-028) — last-sync metadata + multipart fetcher form posting the `sync-upload` intent (.zip upload)  |
